...
namespace ECARules4All_DLL.Taxonomies.Objects.Characters.Animals.Subcategories
{
    ...
    /// This class extends the functionality of <see cref="ECAAnimal"/> to include robot-specific behaviors.
    /// </summary>
    [ECARules4All("robot")]
    ...
    public class ECARobot : MonoBehaviour
    {
        ...
        [Action(typeof(ECARobot), "runs to", typeof(Position))]
        ...
        [Action(typeof(ECARobot), "runs on", typeof(Path))]
        ...
        [Action(typeof(ECARobot), "swims to", typeof(Position))]
        ...
        [Action(typeof(ECARobot), "swims on", typeof(Path))]
        ...
        [ECARelevance(true)]
        [Action(typeof(ECARobot), "walks to", typeof(Position))]
        ...
        [ECARelevance(true)]
        [Action(typeof(ECARobot), "walks on", typeof(Path))]
